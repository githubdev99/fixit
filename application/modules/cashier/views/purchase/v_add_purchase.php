<div class="row page-title">
    <div class="col-12">
        <div class="float-left">
            <h4 class="mb-1 mt-0">Tambah Data Pembelian Supplier</h4>
        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label">Nama Supplier <span class="text-danger">*</span></label>
                                <div class="col-lg-10">
                                    <input type="text" name="supplier_name" class="form-control add" placeholder="Masukkan nama" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label">Barang <span class="text-danger">*</span></label>
                                <div class="col-lg-4">
                                    <select class="form-control select2 add" id="item_option" data-placeholder="Pilih salah satu">
                                    </select>
                                </div>
                                <div class="col-lg-2">
                                    <input type="text" id="qty" class="form-control add" placeholder="Kuantitas" required onkeypress="number_only(event)">
    ...
    <div class="col-12">
        <div class="row">
            <div class="col text-right">
                <a href="<?= base_url() ?>cashier/purchase" class="btn btn-soft-dark btn-lg mr-2">Batal</a>
